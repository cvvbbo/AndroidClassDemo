...
public class httputils1 extends AsyncTask<String ,Void,Bitmap> {
    ...
    public httputils1(httputils1.resultcallback resultcallback) {
    ...
    protected Bitmap doInBackground(String... strings) {
        try {
            ...
            // todo 使用下面这个方法就是会报错 也百度过应该是api的问题？？
    ...
    protected void onPostExecute(Bitmap bitmap) {
        ...
        Log.e("---", "sss");
        resultcallback.getbitmap(bitmap);
    }
